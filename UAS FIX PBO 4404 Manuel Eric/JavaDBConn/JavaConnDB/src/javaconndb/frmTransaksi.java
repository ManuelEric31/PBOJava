...
public class frmTransaksi extends javax.swing.JFrame {
    ...
    DefaultTableModel tableModel = new DefaultTableModel(
        new Object [][] {},
        new String [] {
        "Kd Barang", "Nama Barang","Harga Barang","Jumlah","Total", "Diskon", "Harga Diskon"
    });
...
private void setTombol(boolean t)
{
    ...
    {
        double xtot,xhrg, diskon, harga_diskon;
        int xjml;

        xhrg=Double.parseDouble(txtHarga.getText());
        xjml=Integer.parseInt(txtJml.getText());
        diskon = Double.parseDouble(txtDiskon.getText());
        harga_diskon = Double.parseDouble(txtHargaDiskon.getText());
        
        harga_diskon = (diskon/100)*xhrg*xjml;
        xtot=(xhrg*xjml)-harga_diskon;
        String xtotal=Double.toString(xtot);
        txtTot.setText(xtotal);
        total=xtot;
        txtTotal.setText(Double.toString(total));
        txtHargaDiskon.setText(Double.toString(harga_diskon));
    }
...
//    }
    ...
    private void simpan_ditabel()
    {
        try{
            ...
            double harga_diskon=Double.parseDouble(txtHargaDiskon.getText());
            tableModel.addRow(new Object[]{tKode,tNama,hrg,jml,tot,diskon,harga_diskon});
            inisialisasi_tabel();
        }
        catch(Exception e)
        {
    ...
    private void simpan_transaksi()
    {
        try{
            ...
            for(int i=0;i<tblJual.getRowCount();i++)
            {
                ...
                double xhargadiskon = (Double)tblJual.getValueAt(i,6);
                String zsql="insert into djual values('"+xnojual+"','"+xkd+"',"+xhrg+","+xjml+", "+xhargadiskon+")";
    ...
    private void hitung_bayar(){
        double xtotal,xbayar, xkembali, xhargadiskon;

        xtotal=Double.parseDouble(txtTotal.getText());
        xbayar=Double.parseDouble(txtBayar.getText());   
        xhargadiskon=Double.parseDouble(txtHargaDiskon.getText());
  ...
  private void showMessage(boolean isError, String message) {
    ...
    private void initComponents() {
        ...
        tblJual.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Barang", "Nama Barang", "Harga Barang", "Jumlah", "Total", "Diskon", "Harga Diskon"
            }
        ));
        ...
        txtHargaDiskon.setText("0");
        txtHargaDiskon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtHargaDiskonActionPerformed(evt);
            }
        });
    ...
    private void cmdCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCetakActionPerformed
      ...
      for(int i=0;i<tblJual.getRowCount();i++)
      {
          ...
          double xdiskon=(Double)tblJual.getValueAt(i,5);
          double xhargadiskon=(Double)tblJual.getValueAt(i,6);
          ctk=ctk+"\n"+xkd+"\t"+xnama+"\t\t"+xhrg+"\t"+xjml+"\t"+xtot+"\t"+xdiskon+"\t"+xhargadiskon;
      }

      ctk=ctk+"\n"+"--------------------------------------------------------------------------------------------------------------------------------";
      ctk=ctk+"\nTotal:\t\t\t\t\t"+txtTotal.getText();
      ctk=ctk+"\nBayar:\t\t\t\t\t"+txtBayar.getText();
      ctk=ctk+"\nHarga Diskon:\t\t\t\t\t"+txtHargaDiskon.getText();
      ctk=ctk+"\n"+"--------------------------------------------------------------------------------------------------------------------------------";
    ...
    private void txtHargaDiskonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtHargaDiskonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtHargaDiskonActionPerformed
